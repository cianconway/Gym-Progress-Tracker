...
from websiteapp.app import create_app
from websiteapp.database import db
from websiteapp.settings import DevConfig, ProdConfig
from websiteapp.user.models import User

CONFIG = ProdConfig if os.environ.get('WEBSITEAPP_ENV') == 'prod' else DevConfig
